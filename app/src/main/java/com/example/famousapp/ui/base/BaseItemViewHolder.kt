...
import com.example.famousapp.famous.di.component.DaggerViewHolderComponent
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    open fun registerListener(listener : onViewItemClicked){
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as FamousApplication).applicationComponent)
